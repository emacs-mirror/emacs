...
The optional argument REMOTE-HOST, if non-nil, should be a string
returned by `file-remote-p'.  If it is non-nil and FILE is absolute,
check whether FILE exists on REMOTE-HOST.  The returned name uses
REMOTE-HOST as the prefix if the file exists."
  (let ((non-essential t))
    (cond
