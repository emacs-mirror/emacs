...
(modify-category-entry '(#x20000 . #x2FFFF) ?c)
(modify-category-entry '(#x30000 . #x33479) ?|)
(modify-category-entry '(#x30000 . #x33479) ?C)
(modify-category-entry '(#x30000 . #x33479) ?c)
...
(modify-category-entry '(#x1B124 . #x1B128) ?K)
(modify-category-entry '(#x1B164 . #x1B168) ?K)
...
(modify-category-entry #x1B123 ?H)
...
(let ((tbl (standard-case-table)) c)
  ...
  (modify-category-entry '(#x1E00 . #x1EFF) ?l)
