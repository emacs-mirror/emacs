 ...
 *
 * $HopeName: MMsrc!eventgen.h(trunk.13) $
 *
 * !!! DO NOT EDIT THIS FILE !!!
 * This file was generated by MMsrc!eventgen.pl(MMdevel_color_pool.1) $
 */
...
#define EVENT_PDDUUU(type, _p0, _d1, _d2, _u3, _u4, _u5) \
  BEGIN \
    size_t _length = sizeof(EventPDDUUUStruct); \
    EVENT_BEGIN(type, PDDUUU, _length); \
    Event.pdduuu.p0 = (_p0); \
    Event.pdduuu.d1 = (_d1); \
    Event.pdduuu.d2 = (_d2); \
    Event.pdduuu.u3 = (_u3); \
...
#define EventFormatUUPA 19
#define EventFormatUUPP 20
#define EventFormatWS 21
...
#define EVENT_PDDUUU(type, p0, p1, p2, p3, p4, p5)    NOOP
