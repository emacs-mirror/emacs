 ...
 * This file was generated by MMsrc!eventgen.pl(trunk.7) $
 */
...
#define EVENT_PWWWWDD(type, _p0, _w1, _w2, _w3, _w4, _d5, _d6) \
  BEGIN \
    ...
    Event.pwwwwdd.p0 = (_p0); \
    Event.pwwwwdd.w1 = (_w1); \
    Event.pwwwwdd.w2 = (_w2); \
    Event.pwwwwdd.w3 = (_w3); \
    Event.pwwwwdd.w4 = (_w4); \
    Event.pwwwwdd.d5 = (_d5); \
    Event.pwwwwdd.d6 = (_d6); \
    EVENT_END(type, _length); \
  END
...
#define EVENT_PWWWWWWWWW(type, _p0, _w1, _w2, _w3, _w4, _w5, _w6, _w7, _w8, _w9) \
  BEGIN \
    ...
    Event.pwwwwwwwww.p0 = (_p0); \
    Event.pwwwwwwwww.w1 = (_w1); \
    Event.pwwwwwwwww.w2 = (_w2); \
    Event.pwwwwwwwww.w3 = (_w3); \
    Event.pwwwwwwwww.w4 = (_w4); \
    Event.pwwwwwwwww.w5 = (_w5); \
    Event.pwwwwwwwww.w6 = (_w6); \
    Event.pwwwwwwwww.w7 = (_w7); \
    Event.pwwwwwwwww.w8 = (_w8); \
    Event.pwwwwwwwww.w9 = (_w9); \
    EVENT_END(type, _length); \
  END
...
#define EVENT_PWWWWWWWWWWWW(type, _p0, _w1, _w2, _w3, _w4, _w5, _w6, _w7, _w8, _w9, _w10, _w11, _w12) \
  BEGIN \
    ...
    Event.pwwwwwwwwwwww.p0 = (_p0); \
    Event.pwwwwwwwwwwww.w1 = (_w1); \
    Event.pwwwwwwwwwwww.w2 = (_w2); \
    Event.pwwwwwwwwwwww.w3 = (_w3); \
    Event.pwwwwwwwwwwww.w4 = (_w4); \
    Event.pwwwwwwwwwwww.w5 = (_w5); \
    Event.pwwwwwwwwwwww.w6 = (_w6); \
    Event.pwwwwwwwwwwww.w7 = (_w7); \
    Event.pwwwwwwwwwwww.w8 = (_w8); \
    Event.pwwwwwwwwwwww.w9 = (_w9); \
    Event.pwwwwwwwwwwww.w10 = (_w10); \
    Event.pwwwwwwwwwwww.w11 = (_w11); \
    Event.pwwwwwwwwwwww.w12 = (_w12); \
    EVENT_END(type, _length); \
  END
...
#define EVENT_WS(type, _w0, _s) \
  BEGIN \
    ...
    _length = \
      IndexAlignUp(offsetof(EventWSStruct, s1) \
                   + _string_length + 1, \
                   sizeof(Word)); \
    EVENT_BEGIN(type, WS, _length); \
    Event.ws.w0 = (_w0); \
    mps_lib_memcpy(Event.ws.s1, (_s2), _string_length + 1); \
    EVENT_END(type, _length); \
  END
